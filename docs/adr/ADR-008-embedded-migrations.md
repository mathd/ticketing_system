...
**Superseded on placement** by [ADR-022](./ADR-022-out-of-band-service-migrations.md) (TKT-66,
...
- **Negative:**
    - Deploy = migrate; a bad migration blocks service start (accepted: fail-fast is the
      desired behavior at this scale). *Resolved by [ADR-022](./ADR-022-out-of-band-service-migrations.md).*
    - Startup ordering with future multi-replica services needs goose's advisory-lock
      ...
      [ADR-022](./ADR-022-out-of-band-service-migrations.md) answers it by removing migration from
