...
for var in INTERNAL_SERVICE_TOKEN CATALOG_STAFF_WRITE_TOKEN COMMERCE_STAFF_WRITE_TOKEN COMMERCE_CUSTOMER_ASSERTION_KEY PAYMENTS_INTERNAL_TOKEN ACCESS_TICKET_LINK_KEY; do
